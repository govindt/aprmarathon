...
create table Beneficiary(
	benefeciary_id number primary key,
	benefeciary_name varchar2(50),
...
create table Participant(
	...
	participant_emergency_contact varchar2(50) not null,
	participant_emergency_phone varchar2(20) not null,
...
create table Result(
	...
	result_winner_registrrant number references Registrant(Registrant_Id),
