    ...
    */
    public int doEndTag() throws JspTagException
    {
        ...
        try
        {
            ...
            sbscript.append("<script language=\"JavaScript\" src=\"" + AppConstants.JSP_BASE + "dynamic_menu.js\"></script>");
            sbscript.append("<script language=\"javascript\">");
            sbscript.append("initmenu(6,20,154,200,\"horizontal\");");
            sbscript.append(getMenu());
            sbscript.append("createmenu();");
            sbscript.append("add10xitems();");
            sbscript.append("</script>");

            sbscript.append("<TABLE cellspacing=\"0\" cellpadding=\"0\" border=\"0\" width=\"760\" align=\"center\">");
            ...
            sbscript.append("<script language=\"javascript\">");
            sbscript.append("MENU_POS['block_left'][0]=3;");
            sbscript.append("MENU_POS['block_top'][0]=document.getElementById('holdmenu').offsetTop;");
